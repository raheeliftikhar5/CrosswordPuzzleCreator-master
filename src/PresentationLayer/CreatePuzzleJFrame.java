...
public class CreatePuzzleJFrame extends javax.swing.JFrame {
    ...
    public CreatePuzzleJFrame() {
        ...
        DefaultTableModel m = (DefaultTableModel)puzzlejTable.getModel();
    ...
    private void initComponents() {
        ...
        printablejPanel.setLayout(new javax.swing.BoxLayout(printablejPanel, javax.swing.BoxLayout.LINE_AXIS));

        mainjSplitPane.setBorder(null);
        mainjSplitPane.setDividerLocation(595);
        ...
        puzzlejPanel.setSize(new java.awt.Dimension(595, 542));
        ...
        puzzlejPanel.add(puzzlejScrollPane);
        puzzlejScrollPane.setBounds(0, 0, 590, 590);
        ...
        cluesjPanel.add(cluesjSplitPane);

        mainjSplitPane.setRightComponent(cluesjPanel);

        printablejPanel.add(mainjSplitPane);

        mainjScrollPane.setViewportView(printablejPanel);

        middlejPanel.add(mainjScrollPane);
...
//              }
    ...
    private void documentWidthjSpinnerStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_documentWidthjSpinnerStateChanged
        updateDocSizeFromSpinners();
        //resize jPanel
        Dimension d = new Dimension((int)docWidth,(int)docHeight);
        printablejPanel.setPreferredSize(d);
        mainjScrollPane.setPreferredSize(d);
        printablejPanel.revalidate();
        mainjScrollPane.revalidate();
//        System.out.println(mainjScrollPane.getPreferredSize());
//        d =getSize();
//        pack();
//        setSize(d);        
